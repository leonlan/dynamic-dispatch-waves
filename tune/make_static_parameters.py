...
PARAM_SPACE = {
    "node_ops": {
        ...
        "Exchange11": Bool(False),
        "Exchange20": Bool(False),
        "MoveTwoClientsReversed": Bool(False),
        "Exchange21": Bool(False),
        "Exchange22": Bool(False),
        "Exchange30": Bool(False),
        "Exchange31": Bool(False),
        "Exchange32": Bool(False),
        "Exchange33": Bool(False),
        "TwoOpt": Bool(True),
    },
    "route_ops": {
    ...
    "population": {
        "min_pop_size": Integer((1, 20), 5),
        "generation_size": Integer((1, 40), 3),
        "nb_elite": Integer((0, 2), 2),
        "nb_close": Integer((1, 2), 2),
        "lb_diversity": Float((0, 0.25), 0.11),
        "ub_diversity": Float((0.25, 1), 0.35),
    },
    "neighbourhood": {
    ...
    "penalty": {
        "init_capacity_penalty": Integer((1, 100), 20),
        "init_time_warp_penalty": Integer((1, 100), 6),
        "repair_booster": Integer((1, 100), 12),
        "num_registrations_between_penalty_updates": Integer((1, 500), 50),
